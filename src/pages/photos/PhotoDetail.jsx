...
import {PhotoDetailPage} from "./styles/index";
                                ...
                                <div className="comment_container">
                                    ...
                                    <div className="photo_desc">
                                        <p className="photo_desc_info">
                                            <span className="photo_desc_nickname">
                                                {photo.nickname}
                                            </span>{" "}
                                            {photo.title}
                                        </p>
                                        <p className="photo_desc_desc">
                                            {photo.desc}
                                        </p>
                                    </div>
